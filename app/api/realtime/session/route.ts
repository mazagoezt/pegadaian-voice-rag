...
export async function GET(){
  ...
  const headers: Record<string,string> = { "Authorization":`Bearer ${apiKey}`, "Content-Type":"application/json", "OpenAI-Beta":"realtime=v1" }; if (org) headers["OpenAI-Organization"] = org;
